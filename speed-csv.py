#!/usr/bin/python
#Python script to run a speed test and output results to CSV
#Copied this and modified from the web, cant find the original source to reference
...
try:
    if os.stat('/home/dan/speedtest.csv').st_size == 0:
